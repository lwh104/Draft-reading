...
"""
python deploy/python/infer.py --config models/ca_u2netp_320/deploy.yaml --image_path datasets/val_datasets_320/images_320 --save_dir models/ca_u2netp/predict --batch_size 16 --use_trt True --benchmark True
